...
A set of icons for use with Waybar.
...
- [ ] Redesign Bluetooth off icon.

### Extra

- [ ] Make a sharply squared/angular icon set as well. (Use variable features so that, if supported, the battery can charge/drain using only one glyph, for example.)
